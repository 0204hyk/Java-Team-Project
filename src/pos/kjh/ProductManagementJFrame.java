...
public class ProductManagementJFrame extends JFrame {
	...
	public void buttons() throws IOException {
		...
		add(btnImage("PosImages/상품 관리 이미지/수정 시작 버튼.png","PosImages/상품 관리 이미지/수정 시작 버튼 클릭.png", 900, 620, 120, 55));
		add(btnImage("PosImages/상품 관리 이미지/추가 시작 버튼.png","PosImages/상품 관리 이미지/추가 시작 버튼 클릭.png", 770, 620, 120, 55));
		add(tp);
