...
public class NoHotAndMilk extends JFrame {

	String root = "images/KioskImages/4. detailedOption";
	String imageRoot = "images/KioskImages/4. detailedOption/";
	public NoHotAndMilk() {
...
//		add(nameEng);
		...
		JButton noDecaffein = makeButton("noDecaffein.png", 36, 337, 79, 73);
		JButton toDecaffein = makeButton("toDecaffein.png", 125, 337, 79, 73);
		add(noDecaffein);
		add(toDecaffein);
