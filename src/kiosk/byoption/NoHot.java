...
//		add(nameEng);
		...
		add(makeLabel("changeDecaffein.png", 46, 313, 114, 17));
		JButton noDecaffein = makeButton("noDecaffein.png", 34, 337, 79, 73);
		JButton toDecaffein = makeButton("toDecaffein.png", 123, 337, 79, 73);
		add(noDecaffein);
		add(toDecaffein);
		new GroupButtons(noDecaffein, toDecaffein, "noDecaffein", "toDecaffein", 79, 73);

		add(makeLabel("selectCup.png", 368, 312, 59, 17));
		JButton useDisposal = makeButton("useDisposal.png", 356, 337, 79, 73);
