...
//		add(nameEng);
		...
		add(makeLabel("selectCup.png", 44, 312, 59, 17));
		JButton useDisposal = makeButton("useDisposal.png", 35, 337, 79, 73);
		JButton useTumbler = makeButton("useTumbler.png", 124, 336, 79, 73);
